...
<body>
  ...
  <main>
      ...
      <div class="owl-carousel owl-theme carousel_4">
        ...
        <div class="item">
          <div class="strip">
            ...
            <ul>
              <li><span class="loc_open"> Ready Stock </span></li>
              <li>
                <div class="score"><span> Rating <br> 109 Reviews</span><strong>8.9</strong></div>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="call_section lazy" data-bg="url(/assets/frontend/banner.jpg)">

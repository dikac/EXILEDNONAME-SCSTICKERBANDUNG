...
<li class="menu-section">
  <h4 class="menu-text"> OTHER PAGES </h4>
  <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
</li>
<!-- <li class="menu-item {{ (request()->is('dashboard/banners*')) ? 'menu-item-active' : '' }}"><a href="/dashboard/banners" class="menu-link"><i class="menu-icon fas fa-list-ul"></i><span class="menu-text"> Banners </span></a></li> -->
<li class="menu-item {{ (request()->is('dashboard/galleries*')) ? 'menu-item-active' : '' }}"><a href="/dashboard/galleries" class="menu-link"><i class="menu-icon fas fa-list-ul"></i><span class="menu-text"> Galleries </span></a></li>

...
namespace App\Http\Controllers\Backend\System\Table;
...
use App\Http\Requests\Backend\System\Table\Relation\StoreRequest;
use App\Http\Requests\Backend\System\Table\Relation\UpdateRequest;
...
class RelationController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/tables/relations';
    $this->path = 'pages.backend.system.table.relation.';
    $this->model = 'App\Models\Backend\System\Table\Relation';
  ...
  **/
  ...
  public function index() {
    ...
    if(request()->ajax()) {
      ...
      ->editColumn('id_generals', function($order) { return $order->table_generals->name; })

...
class AppServiceProvider extends ServiceProvider
{
  ...
  */
  public function register() {
    ...
    $this->commands(
      ...
      'App\Console\Commands\CrudRequestStoreCommand',
  ...
  */
  public function boot() {
    ...
    $this->publishes([ __DIR__ . '/../config/crudgenerator.php' => config_path('crudgenerator.php'), ]);
    $this->publishes([ __DIR__ . '/../publish/views/' => base_path('resources/views/'), ]);
    $this->publishes([ __DIR__ . '/stubs/' => base_path('resources/crud-generator/'), ]);

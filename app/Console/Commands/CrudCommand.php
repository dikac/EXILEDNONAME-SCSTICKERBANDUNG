  ...
  */
  ...
  protected function addRoutes()
  {
    ...
    Route::group([
      ...
      Route::get('active/{id}', '$this->controller@active')->name('active');
      Route::get('inactive/{id}', '$this->controller@inactive')->name('inactive');
      Route::get('restore/{id}', '$this->controller@restore')->name('restore');
      Route::get('restoreall', '$this->controller@restoreall')->name('restore-all');
      Route::get('delete-permanent/{id}', '$this->controller@delete_permanent')->name('delete-permanent');
      Route::get('delete-permanentall', '$this->controller@delete_permanentall')->name('delete-permanentall');
      Route::get('delete/{id}', '$this->controller@delete')->name('delete');
      Route::get('deleteall', '$this->controller@deleteall')->name('delete-all');
      Route::get('activities', '$this->controller@activity')->name('activity');
      Route::get('trash', '$this->controller@trash')->name('trash');
      Route::resource('/', '$this->controller')->parameters(['' => 'id']);
    });
    "];
  }

...
class CrudRequestStoreCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'crud:requeststore
     ...
     * @var string
     */
    protected $description = 'Create a new request store.';
    ...
    protected function getStub()
    {
        ...
        ? config('crudgenerator.path') . '/request-store.stub'
        : __DIR__ . '/../stubs/request-store.stub';
    }
